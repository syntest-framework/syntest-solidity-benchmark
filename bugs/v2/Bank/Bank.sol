// https://github.com/marbleprotocol/flash-lending/commit/0a5cfe0521d9fff40310f3b6d05b7a705220a169
/*
...
contract Bank is Ownable, Transfer {
    ...
    * @param amount Amount of token to borrow.
    */
    function borrowFor(address token, address payable who, uint256 amount) public onlyApproved {
