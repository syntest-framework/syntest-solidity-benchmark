...
contract DSP is ERC20Detailed, ERC20Pausable {
    ...
    constructor() ERC20Detailed("DSP", "DSP", 18) public  {
    ...
    function burnFrombyOwner(address from, uint256 amount) public onlyOwner returns (bool) {
        _burn(from, amount);
        return true;
    }
