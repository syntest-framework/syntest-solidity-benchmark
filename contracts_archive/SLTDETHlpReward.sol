...
contract SLTDETHlpReward is LPTokenWrapper, IRewardDistributionRecipient {

    constructor() public {
        rewardDistribution = msg.sender;
    }

    IERC20 public SLTD = IERC20(0x58C0b2EdC5647401042b6f7e4923ed9d993F91A9);
    ...
    function remainingReward() public view returns (uint256) {
        return SLTD.balanceOf(address(this));
    }
